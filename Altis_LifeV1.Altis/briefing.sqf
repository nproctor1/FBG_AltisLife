...
Date: 19. January 2016<br/><br/>
    ...
    player createDiaryRecord["Server Credits",
        [
            "Server Credits",
                "
Owner:Reaper<br/>
Developer: [Prior] Shadow<br/>
Beta Testers: Sgt.Rock, ScuttieTheCrab<br/>
Staff:<br/>
Admins: [Prior] Shadow, Reaper
Moderators: Sgt. Rock
                "
        ]
    ];
...
5. Abusing bugs or game mechanics for gain. Is there a replicating gun somewhere? Report it and leave it alone. If an admin catches you abusing the glitch, ban.<br/><br/>
    ...
    player createDiaryRecord["pmcrules",
        [
            "PMC Rules and info",
                "
PMC Members are not aloud to take money and run, and the customer must pay. Failing to follow will result in temp ban.<br/><br/>
Police Contracts can only be made with the cheif<br/>
Must info police of there mission if in a town<br/>
If caught doing illegal things your fines will be greater, and PMC will be revoked.<br/>
Must apply to run a PMC group. <br/><br/>
                "
        ]
    ];
...
Small roads: 30km/h<br/>
Main roads: 40km/h<br/>
