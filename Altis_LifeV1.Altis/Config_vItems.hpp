...
class VirtualShops {
	...
	class ems_items {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon",};
    };
    ...
    class pmcItem {
        ...
        license = "PMCSoldier";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "rabbit", "redgull", "zipties", "fuelFull", "tbacon", "lockpick", "pickaxe", "peach", "boltcutter", "blastingcharge"};
    };
};
