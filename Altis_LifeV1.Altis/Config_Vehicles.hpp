    ...
    */
    class civ_car {
        ...
        vehicles[] = {
            ...
            { "C_Hatchback_01_sport_F", 23000, { "driver" }, { "", "", -1 } },
            { "C_Van_01_transport_F", 20000, { "driver" }, { "", "", -1 } },
            { "C_Offroad_02_unarmed_F", 12500, { "", "", -1 } } 
        };
    };
    ...
    class cop_car {
        side = "cop";
        vehicles[] = {
            { "C_Offroad_01_F", 3000, { "" }, { "", "", -1 } },
            { "C_SUV_01_F", 15000, { "" }, { "", "", -1 } },
            { "C_Hatchback_01_sport_F", 25000, { "" }, { "life_coplevel", "SCALAR", 1 } },
            { "B_MRAP_01_F", 25000, { "" }, { "life_coplevel", "SCALAR", 2 } },
	...
	class PMC_Land {
        side = "civ";
        vehicles[] = {
            { "I_MRAP_03_F", 500000, { "driver" }, { "", "", -1 } },
            { "B_T_LSV_01_unarmed_F", 900000, { "driver" }, { "", "", -1 } },
            { "I_G_Offroad_01_F", 10000, { "driver" }, { "", "", -1 } }
        };
	};
	class PMC_Air {
        side = "civ";
        vehicles[] = {
            { "B_T_VTOL_01_infantry_blue_F", 800000, { "pilot" }, { "", "", -1 } },
            { "B_T_VTOL_01_vehicle_F", 1500000, { "pilot" }, { "", "", -1 } },
            { "B_Heli_Light_01_F", 150000, { "pilot" }, { "", "", -1 } }
        };
    };
};
    ...
    */
    ...
    class C_Offroad_01_F {
        ...
        textures[] = {
			...
			{ "Desert Digi", "reb", {
                "textures\digi_desert.paa"
            } },
			{ "Woodland Digi", "reb", {
                "textures\digi_wood.paa"
            } }
        };
    };
	...
	class O_LSV_02_armed_black_F {
        vItemSpace = 50;
        storageFee[] = { 10000000, 0, 0, 0 };
        garageSell[] = { 3000000, 0, 0, 0 };
        insurance = 2500;
        chopShop = 1000000;
        textures[] = {};
	};
	...
	class B_T_VTOL_01_vehicle_F {
        vItemSpace = 300;
        storageFee[] = { 3000000, 0, 0, 0 };
        garageSell[] = { 1500000, 0, 0, 0 };
        insurance = 2500;
        chopShop = 1000000;
        textures[] = {};
    };
